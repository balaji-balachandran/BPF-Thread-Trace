...
def parse_address(url_or_ip):
    ...
    # if not check if valid URL,what is bpf parse and get its domain, resolve it to IPv4 and return it
    try:
...
# Will block until the pipe gets some input.
bpf.trace_print()
while True:
    try:
